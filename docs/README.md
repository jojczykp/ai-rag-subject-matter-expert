...
Start here when restoring project context or reviewing the design.

## Product And Planning

- [PRD](PRD.md): current product scope, non-goals, APIs, and acceptance
  criteria.
- [Implementation Plan](IMPLEMENTATION_PLAN.md): delivered milestones and
  remaining future work.

## Architecture

- [Architecture](ARCHITECTURE.md): high-level runtime, retrieval, and component
  design.
- [Database Schema](DATABASE_SCHEMA.md): PostgreSQL + pgvector schema diagram.
- [Configuration Reference](CONFIGURATION.md): application properties and
...
- [README](../README.md): quick start, build/run commands, and troubleshooting.
- [AGENTS](../AGENTS.md): project agents and collaboration conventions.
