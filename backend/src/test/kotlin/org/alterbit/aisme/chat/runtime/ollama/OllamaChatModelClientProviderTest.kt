...
class OllamaChatModelClientProviderTest {
    ...
    private fun springChatModel(id: String): Pair<String, ChatModelProperties> =
        id to ChatModelProperties(
            enabled = true,
